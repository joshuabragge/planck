 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | GUI  |HyperZ|Lower |Space | Bksp |Raise | LEAD |      |      | -/_  |
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    KC_LCTL,       KC_LALT, KC_LGUI, HYPR(KC_Z), LOWER,   SPACE,  BACKSPACE,  RAISE,   KC_LEAD, KC_NO, KC_NO,   TD(CT_UNDER)
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______,  KC_MINS,   KC_EQL,   _______,   _______,   _______,   KC_HOME,   KC_LEFT,    KC_DOWN,    KC_UP,   KC_RGHT, KC_END,
